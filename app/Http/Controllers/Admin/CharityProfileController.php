...
use App\Models\CharityCa1;
use App\Models\CharityCa1Ca2;
use App\Models\CharityCa2;
...
class CharityProfileController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.charity_profile.create',compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //print_r($leadership_team_photos);exit;
    ...
    public function edit($id)
    {
        ...
        $countries =  DB::table('country')->pluck('name','id');
        return view('admin.charity_profile.edit',compact('charity_profile','countries'));
    }
