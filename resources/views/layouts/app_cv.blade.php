...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/cv/css/jasny-bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/cv/css/cv_style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/cv/css/edit-resume.css') }}">
</head>
