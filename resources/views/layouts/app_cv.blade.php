...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/cv/assets/css/jasny-bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/cv/assets/css/cv_style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/cv/assets/css/edit-resume.css') }}">
</head>
...
{{--manu js--}}
<script src="http://engineers.limited/assets/corporate/scripts/jq.js"></script>
<script src="http://engineers.limited/assets/corporate/scripts/1.js"></script>
<script src="http://engineers.limited/assets/corporate/scripts/2.js"></script>
