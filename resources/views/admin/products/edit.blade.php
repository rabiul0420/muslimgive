                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" class="form-control" value="{{$products->title}}" required name="title">
                                            </div>

                                            <div class="form-group">
                                                <label>Product Type</label>
                                                @php $type->prepend('Select Product Type','')  @endphp
                                                {!! Form::select('product_type_id', $type, $products->product_type_id,['class'=>'form-control']) !!}<i></i>
                                            </div>

                                            <div class="form-group ckeditor">
                                                <label>Description</label>
                                                <textarea class="editor"  rows="20" name="description" class="custom-scroll">{{$products->description}}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Status</label>
                                                {!! Form::select('status', ['Active' => 'Active','InActive' => 'InActive'], $products->status,['class'=>'form-control']) !!}<i></i>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <img id="holder_image" src="{{asset($products->logo)}}" style="margin-top:15px;margin-bottom:5px;max-width:100%;">
