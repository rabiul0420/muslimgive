                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                    {!! Form::open(['action'=>['Admin\PaymentsController@update',$payments->id],'method'=>'PUT','files'=>true]) !!}
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('course_id', $courses, $payments->usercourse->course_id,['class'=>'form-control']) !!}<i></i>
                                            </div>

                                            <div class="form-group">
                                                <label>Select User</label>
                                                @php $users->prepend('Select Course','')  @endphp
                                                {!! Form::select('user_id', $users, $payments->usercourse->user_id,['class'=>'form-control']) !!}<i></i>
                                            </div>


                                            <div class="form-group">
                                                <label>Amount</label>
                                                <input type="text" name="amount" value="{{ $payments->amount }}"  class="form-control" id="contacts-name">
                                            </div>


                                            <div class="form-group">
                                                <label>Status</label>
                                                {!! Form::select('status', ['Active' => 'Active','Pending' => 'Pending'], $payments->status,['class'=>'form-control']) !!}<i></i>
                                            </div>
