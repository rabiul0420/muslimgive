                                        ...
                                        <div class="row">
                                            <fieldset class="col-md-6">
                                                ...
                                                <section>
                                                    ...
                                                    <label class="input">
                                                        <input type="text" value="{{old('title_bottom')}}"  name="title_bottom">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="input">
                                                        <input type="text" value="{{old('button_title')}}"  name="button_title">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="select">
                                                        {!! Form::select('link_target', ['_self' => 'None','_blank' => 'New Tab'], old('link_target'),['class'=>'form-control']) !!}<i></i>
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="select">
                                                        ...
                                                        {!! Form::select('category_id', $category, old('category_id'),['class'=>'form-control']) !!}<i></i>
                                                    </label>
                                                </section>
