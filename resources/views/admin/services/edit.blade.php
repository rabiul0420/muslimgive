...
@section('content')
    ...
    <div id="main" role="main">
        <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>Home</li><li>Edit Services</li>
                </ol>
        </div>
                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                    {!! Form::open(['action'=>['Admin\ServicesController@update',$services->id],'method'=>'PUT','files'=>true]) !!}
                                    <div class="row">
                                        <div class="col-md-8">

                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" class="form-control" value="{{$services->title}}" required name="title">
                                            </div>

                                            <div class="form-group">
                                                <label>Font Awesome Icon Class</label>
                                                <input type="text" value="{{$services->icon_class}}" class="form-control" required name="icon_class">
                                            </div>

                                            <div class="form-group">
                                                <label>Short Description</label>
                                                <textarea  class="form-control"  name="short_description">{{$services->short_description}}</textarea>
                                            </div>


                                            <div class="form-group ckeditor">
                                                <label>Description</label>
                                                <textarea class="editor"  rows="20" name="description" class="custom-scroll form-control">{{ $services->description }}</textarea>
                                            </div>


                                            <div class="form-group">
                                                <label>Status</label>
                                                {!! Form::select('status', ['Active' => 'Active','InActive' => 'InActive'], $services->status,['class'=>'form-control']) !!}<i></i>
                                            </div>
