                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                        {!! Form::open(['action'=>'Admin\ServicesController@store','files'=>true]) !!}
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{old('icon_class')}}" class="form-control" required name="icon_class">
                                                </div>
                                                ...
                                                <div class="form-group ckeditor">
                                                    ...
                                                    <textarea class="editor"  rows="20" name="description" class="custom-scroll form-control">{{old('description')}}</textarea>
                                                </div>
                                        ...
                                        <footer>
                                            ...
                                            <a href="{{ url('admin/services') }}" class="btn btn-default">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
