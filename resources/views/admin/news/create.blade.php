            ...
            <section id="widget-grid" class="">
                    ...
                    <article class="">
                        ...
                        <div class="input-group">
                                <!--<form action="?" method="POST" entype="multipart/from-data">
                                <label for="">uploading file</label>
                                <p><input type="file" name="file"></p>
                                <p><input type="submit" name="upload" value="Upload Image"></p></form>-->
                                <tr>
                            ...
                            <input id="thumbnail" class="form-control" type="hidden" name="image">
                                        ...
                                        <footer>
                                            ...
                                            <a href="{{ url('admin/news') }}" class="btn btn-default">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
