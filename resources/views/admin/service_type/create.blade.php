...
@section('content')
    ...
    <div id="main" role="main">
        <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>Home</li><li>Add Service Type</li>
                </ol>
        </div>
                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                        {!! Form::open(['action'=>'Admin\ServiceTypeController@store','files'=>true]) !!}
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <footer>
                                            ...
                                            <a  class="btn btn-default" href="{{ url('admin/service-type') }}">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
