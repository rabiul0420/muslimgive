...
@section('content')
    ...
    <div id="main" role="main">
        <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>Home</li><li>Add Jobs Category</li>
                </ol>
        </div>
                    ...
                    <article class="">
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            <header>
                                ...
                                <h2>Add Jobs Category </h2>
                            </header>
                            <div>
                                <div class="widget-body">
                                        {!! Form::open(['action'=>'Admin\JobsCategoryController@store','files'=>true]) !!}
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <footer>
                                            ...
                                            <a  class="btn btn-default" href="{{ url('admin/jobs-category') }}">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
